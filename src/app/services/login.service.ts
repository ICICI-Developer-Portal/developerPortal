...
constructor(private http: Http,private config: Config,private HttpClient:HttpClient,private router : Router){
    ...
    //#region Login Api
     Login(data){
      ...
      LoginPortal(json){
        ...
        return  this.HttpClient.post<any>('https://sandbox.icicibank.com/login', formData,options)
      }
      ...
      LogoutPortal(){
        ...
        return  this.HttpClient.get<any>('https://sandbox.icicibank.com/logout',options);
      }
      ...
      sign_up(data){
        ...
        sign_upjira(data){
         ...
         // for (key in data) { query += encodeURIComponent(key)+"="+encodeURIComponent(data[key])+"&"; }
          ...
          let options = new RequestOptions( { headers: headers });
            return this.http.post('https://sandbox.icicibank.com/rest/doc/save-portal-details ',data, options);
        }
  ...
  Sample_packet(data){
    ...
    return this.HttpClient.post(this.apiUrl+'load-api-packet',body.toString(),options);
  }
...
//merchant-onboarding Strat
    Merchant_onboarding(formdata){ 
       var key ;
        ...
        return this.http.post('https://developerapi.icicibank.com:8443/api/v1/jira',formdata);
      }
  ...
  feedback(json){
    ...
    let headers = new Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
    let options = new RequestOptions( { headers: headers });
    return this.http.post('https://sandbox.icicibank.com/rest/feedback',query, options);
  }
    ...
    Onboardrequests(){ 
      ...
      GetPendingReg(){ 
        ...
        let headers = new Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        let options = new RequestOptions({ headers: headers });
        return this.http.post(this.apiUrl+'fetch-pending-userReg',query, options);    
      } 
      ...
      ApproveReg(json){
        ...
        let headers = new Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        let options = new RequestOptions({ headers: headers });
        return this.http.post(this.apiUrl+'approve-pending-userReg',query, options);
